...
SECRET_KEY = 'django-insecure-ze18kba5&-d0oku)u^8229zx(t1cj$3ew$fhwhm%^v3lynp3uk'
...
INSTALLED_APPS = [
    ...
    'employeer','jobseeker', 
    'crispy_forms',
    'crispy_bootstrap4',  # add this for Bootstrap 5 compatibility
]
